...
#read training data
tr_all_class = pd.read_csv('D:/Seafile/Seafile/My Library/IIT Mandi/even_course_feb18/CS669_PR/assignment4/matlab code/pr_asgn4/group2_joe/ds1/ls/training/Tr_all.csv',delimiter=',')
#read testing data
ts_all_class = pd.read_csv('D:/Seafile/Seafile/My Library/IIT Mandi/even_course_feb18/CS669_PR/assignment4/matlab code/pr_asgn4/group2_joe/ds1/ls/testing/Ts_all.csv' ,delimiter=',')
...
model = svm.SVC(kernel='rbf', C=1, gamma=1.54)#radial basis function
...
for x_all in frange(-15,.1, 30):
    for y_all in frange(-15, .1, 17):
        x_a= x_all
        x_b= y_all
