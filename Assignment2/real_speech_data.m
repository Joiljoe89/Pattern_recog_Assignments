...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  GMM for 2D real speech data (DS-2(a)) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


data=load('D:/Seafile/Seafile/My Library/IIT Mandi/even_course_feb18/CS669_PR/assignment2/data/asgn1_data/rd_group2/class1.txt','-ascii');
x_c1=data;
l1=size(x_c1,1);

data=load('D:/Seafile/Seafile/My Library/IIT Mandi/even_course_feb18/CS669_PR/assignment2/data/asgn1_data/rd_group2/class2.txt','-ascii');
x_c2=data;
l2=size(x_c2,1);

data=load('D:/Seafile/Seafile/My Library/IIT Mandi/even_course_feb18/CS669_PR/assignment2/data/asgn1_data/rd_group2/class3.txt','-ascii');
x_c3=data;
l3=size(x_c3,1);
...
data1_tr=x_c1(1:lc1tr,:);   % Train data
data2_tr=x_c2(1:lc2tr,:);
data3_tr=x_c3(1:lc3tr,:);

data1_ts=x_c1(lc1tr+1:end,:);  % Test data
data2_ts=x_c2(lc2tr+1:end,:);
data3_ts=x_c3(lc3tr+1:end,:);
...
Accuracy=(size(RD,1)/ts_l)*100   % Accuracy
 ...
 legend('Class1', 'Class2', 'Class3')
 axis([min_x1-20 max_x1+20 min_x2-20 max_x2+20]);
 xlabel('X1');
 ylabel('X2');
 title('Test data(2D Speech Data)');
  ...
  xlabel('X1');
  ylabel('X2');
  title('Constant density contour with training data(2D Speech)');
  legend('Class1', 'Class2', 'Class3')
  
 n1=130;
 X=linspace(min_x1-20,max_x1+20,n1);
 Y=linspace(min_x2-20,max_x2+20,n1);
 ...
 xlabel('X1');
 ylabel('X2');
 title('Decision region  with training data(2D Speech)');
